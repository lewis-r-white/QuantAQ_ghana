...
location_data <- fread("/Users/lewiswhite/CHAP_columbia/QuantAQ_ghana/data/cloud/ghana_AQ_parent_full_20240925.csv", 
...
prisma_populations <- readxl::read_xlsx(here("data", "modulair_communities.xlsx")) 
...
full_monitor_info <- monitor_locations_full %>% 
  ...
  select(monitor, description, location, locations, geo_lat, geo_lon, households, population)
...
for (gas in gasses) {
  load_pollution_datasets(gas, file_path = "/Users/lewiswhite/CHAP_columbia/QuantAQ_ghana/data/cloud/ghana_AQ_parent_full_20240925.csv", file_type = "csv")
...
# Plotting
ggplot(monitor_obs_count_type, aes(x = description, y = percentage, fill = source)) +
  geom_bar(stat = "identity") +
  labs(
    title = "",
    x = "Monitor",
