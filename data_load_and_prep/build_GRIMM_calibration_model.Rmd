...
## PM DATA ----
modulair_pm_25_hourly <- read_csv(here("data", "pm", "summarized", "pm25_community_hourly_20241031_20250901.csv")) %>%
...
modulair_pm_1_hourly <- read_csv(here("data", "pm", "summarized", "pm1_community_hourly_20241031_20250901.csv")) %>%
  filter(monitor %in% c("MOD-PM-00884")) %>% # filter to monitors co-located with GRIMM
  filter(date > as.Date("2025-08-10")) %>% ## filter data prior to GRIMM deployment 
  filter(!is.na(mean_pm1)) %>%
  select(-c(n_minute_obs, n_active, fleet_average_pm1))

modulair_pm_10_hourly <- read_csv(here("data", "pm", "summarized", "pm10_community_hourly_20241031_20250901.csv")) %>%
  filter(monitor %in% c("MOD-PM-00884")) %>% # filter to monitors co-located with GRIMM
  filter(date > as.Date("2025-08-10")) %>% ## filter data prior to GRIMM deployment 
