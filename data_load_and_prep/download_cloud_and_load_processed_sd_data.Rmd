...
start_date <- as.Date("2025-12-01")  # Due to timezones, start_date needs to be 1 day before the actual start date of interest
...
saveRDS(final_result_df, file = "cloud_monitor_data_20251201_20260315.rds")
```
