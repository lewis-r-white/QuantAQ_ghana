...
ghana_devices <- c("MOD-PM-00884", "MOD-00077", "MOD-00397", "MOD-PM-00879", "MOD-PM-00893")
...
start_date <- as.Date("2024-08-15")  # Due to timezones, start_date needs to be 1 day before the actual start date of interest
...
saveRDS(final_result_df, file = "cloud_monitor_data_20240815_20241031.rds")
write_csv(final_result_df, "ghana_AQ_parent_full_20240815_20241031.csv")
```

```{r}
# batch1 <- read_rds("/Users/lewiswhite/CHAP_columbia/QuantAQ_ghana/processed_monitor_data_20250831_20251201.rds")
# 
# batch2 <- read_rds("/Users/lewiswhite/CHAP_columbia/QuantAQ_ghana/processed_monitor_data_20251201_20260315.rds")
# 
# sept2025_march2026 <- bind_rows(batch1, batch2) %>%
#   distinct(monitor, timestamp, .keep_all = TRUE)
# 
# saveRDS(sept2025_march2026, file = "cloud_monitor_data_20250831_20260315.rds")
# write_csv(sept2025_march2026, "ghana_AQ_parent_full_20250831_20260315.csv")
```
