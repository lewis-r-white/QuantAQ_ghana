...
# check out cleaned data 
combined %>%
  select(datetime, temp_c, rh_percent, pressure_hpa)
```
...
folder <- "/Users/lewiswhite/CHAP_columbia/QuantAQ_ghana/data/FEMs/GRIMM/raw/GRIMM_20251008_20251218"
...
write_csv(grimm_hourly, here("data", "FEMs", "GRIMM", "clean", "grimm_hourly_20251008-20251218.csv"))
...
write_csv(grimm_daily, here("data", "FEMs", "GRIMM", "clean", "grimm_daily_20251008-20251218.csv"))
