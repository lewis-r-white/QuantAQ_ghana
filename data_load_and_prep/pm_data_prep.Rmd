...
cloud_path <- here("data/all_measurements/cloud/ghana_AQ_parent_full_20250831_20260315.csv")
...
# write_rds(corrected_full, here("data", "pm", "final", "corrected_full_data_20250831-20260315.rds"))
```
...
```{r}
# Save as CSV
write_csv(pm1_community_hourly, here("data", "pm", "summarized", "pm1_community_hourly_20250831-20260315.csv"))
write_csv(pm25_community_hourly, here("data", "pm", "summarized", "pm25_community_hourly_20250831-20260315.csv"))
write_csv(pm10_community_hourly, here("data", "pm", "summarized", "pm10_community_hourly_20250831-20260315.csv"))

write_csv(pm1_community_daily, here("data", "pm", "summarized", "pm1_community_daily_20250831-20260315.csv"))
write_csv(pm25_community_daily, here("data", "pm", "summarized", "pm25_community_daily_20250831-20260315.csv"))
write_csv(pm10_community_daily, here("data", "pm", "summarized", "pm10_community_daily_20250831-20260315.csv"))

#
# # Save as RDS
write_rds(pm1_community_hourly, here("data", "pm", "summarized", "pm1_community_hourly_20250831-20260315.rds"))
write_rds(pm25_community_hourly, here("data", "pm", "summarized", "pm25_community_hourly_20250831-20260315.rds"))
write_rds(pm10_community_hourly, here("data", "pm", "summarized", "pm10_community_hourly_20250831-20260315.rds"))

write_rds(pm1_community_daily, here("data", "pm", "summarized", "pm1_community_daily_20250831-20260315.rds"))
write_rds(pm25_community_daily, here("data", "pm", "summarized", "pm25_community_daily_20250831-20260315.rds"))
write_rds(pm10_community_daily, here("data", "pm", "summarized", "pm10_community_daily_20250831-20260315.rds"))
