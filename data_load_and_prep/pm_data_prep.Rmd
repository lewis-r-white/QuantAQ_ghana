...
- Window 2 (new fleet): fit each monitor to the fleet average during its colocation window. 
...
sd_paths <- c(
  here("data/all_measurements/sd/full_sd_card_20241031-20250129.csv"),
  here("data/all_measurements/sd/full_sd_card_20250301-20250901.csv")
)

# if don't have sd data use this
# sd_paths <- character(0) 


cloud_path <- here("data/all_measurements/cloud/ghana_AQ_parent_full_20241031_20250901.csv")
...
cal_pm1  <- readr::read_csv(here::here("data","calibration","calibration_pm1_20251216.csv"),  show_col_types = FALSE)
cal_pm25 <- readr::read_csv(here::here("data","calibration","calibration_pm25_20251216.csv"), show_col_types = FALSE)
cal_pm10 <- readr::read_csv(here::here("data","calibration","calibration_pm10_20251216.csv"), show_col_types = FALSE)
...
write_csv(pm1_corrected, here("data", "pm", "final", "pm1_corrected_20241031_20250901.csv"))

write_csv(pm10_corrected, here("data", "pm", "final", "pm10_corrected_20241031_20250901.csv"))

write_csv(pm25_corrected, here("data", "pm", "final", "pm25_corrected_20241031_20250901.csv"))

write_rds(pm1_corrected, here("data", "pm", "final", "pm1_corrected_20241031_20250901.rds"))

write_rds(pm10_corrected, here("data", "pm", "final", "pm10_corrected_20241031_20250901.rds"))

write_rds(pm25_corrected, here("data", "pm", "final", "pm25_corrected_20241031_20250901.rds"))
...
write_rds(corrected_full, here("data", "pm", "final", "corrected_full_data_20241031_20250901.rds"))
```
...
```{r}
# Save as CSV
write_csv(pm1_community_hourly, here("data", "pm", "summarized", "pm1_community_hourly_20241031_20250901.csv"))
write_csv(pm25_community_hourly, here("data", "pm", "summarized", "pm25_community_hourly_20241031_20250901.csv"))
write_csv(pm10_community_hourly, here("data", "pm", "summarized", "pm10_community_hourly_20241031_20250901.csv"))

write_csv(pm1_community_daily, here("data", "pm", "summarized", "pm1_community_daily_20241031_20250901.csv"))
write_csv(pm25_community_daily, here("data", "pm", "summarized", "pm25_community_daily_20241031_20250901.csv"))
write_csv(pm10_community_daily, here("data", "pm", "summarized", "pm10_community_daily_20241031_20250901.csv"))

#
# # Save as RDS
write_rds(pm1_community_hourly, here("data", "pm", "summarized", "pm1_community_hourly_20241031_20250901.rds"))
write_rds(pm25_community_hourly, here("data", "pm", "summarized", "pm25_community_hourly_20241031_20250901.rds"))
write_rds(pm10_community_hourly, here("data", "pm", "summarized", "pm10_community_hourly_20241031_20250901.rds"))

write_rds(pm1_community_daily, here("data", "pm", "summarized", "pm1_community_daily_20241031_20250901.rds"))
write_rds(pm25_community_daily, here("data", "pm", "summarized", "pm25_community_daily_20241031_20250901.rds"))
write_rds(pm10_community_daily, here("data", "pm", "summarized", "pm10_community_daily_20241031_20250901.rds"))
...
write_csv(full_hourly_summary, here("data", "pm", "summarized", "full_hourly_20241031_20250901.csv"))
...
write_csv(full_daily_summary, here("data", "pm", "summarized", "full_daily_20241031_20250901.csv"))
