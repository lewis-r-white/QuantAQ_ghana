...
cloud_path <- here("data/all_measurements/cloud/ghana_AQ_parent_full_20240815_20241031.csv")
...
# 
# write_csv(pm1_corrected, here("data", "pm", "final", "pm1_corrected_20240816_20241031.csv"))
# 
# write_csv(pm10_corrected, here("data", "pm", "final", "pm10_corrected_20240816_20241031.csv"))
# 
# write_csv(pm25_corrected, here("data", "pm", "final", "pm25_corrected_20240816_20241031.csv"))
# 
# write_rds(pm1_corrected, here("data", "pm", "final", "pm1_corrected_20240816_20241031.rds"))
# 
# write_rds(pm10_corrected, here("data", "pm", "final", "pm10_corrected_20240816_20241031.rds"))
# 
# write_rds(pm25_corrected, here("data", "pm", "final", "pm25_corrected_20240816_20241031.rds"))
...
# write_rds(corrected_full, here("data", "pm", "final", "corrected_full_data_20240816-20241031.rds"))
```
...
```{r}
# Save as CSV
write_csv(pm1_community_hourly, here("data", "pm", "summarized", "pm1_community_hourly_20240816-20241031.csv"))
write_csv(pm25_community_hourly, here("data", "pm", "summarized", "pm25_community_hourly_20240816-20241031.csv"))
write_csv(pm10_community_hourly, here("data", "pm", "summarized", "pm10_community_hourly_20240816-20241031.csv"))

write_csv(pm1_community_daily, here("data", "pm", "summarized", "pm1_community_daily_20240816-20241031.csv"))
write_csv(pm25_community_daily, here("data", "pm", "summarized", "pm25_community_daily_20240816-20241031.csv"))
write_csv(pm10_community_daily, here("data", "pm", "summarized", "pm10_community_daily_20240816-20241031.csv"))

#
# # Save as RDS
write_rds(pm1_community_hourly, here("data", "pm", "summarized", "pm1_community_hourly_20240816-20241031.rds"))
write_rds(pm25_community_hourly, here("data", "pm", "summarized", "pm25_community_hourly_20240816-20241031.rds"))
write_rds(pm10_community_hourly, here("data", "pm", "summarized", "pm10_community_hourly_20240816-20241031.rds"))

write_rds(pm1_community_daily, here("data", "pm", "summarized", "pm1_community_daily_20240816-20241031.rds"))
write_rds(pm25_community_daily, here("data", "pm", "summarized", "pm25_community_daily_20240816-20241031.rds"))
write_rds(pm10_community_daily, here("data", "pm", "summarized", "pm10_community_daily_20240816-20241031.rds"))
