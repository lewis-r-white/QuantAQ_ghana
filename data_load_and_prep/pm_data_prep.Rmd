...
#### OPTIONAL: Use raw (uncalibrated) cloud + SD data for summarization ####
# # If you do NOT want to apply calibration, create a *_data_summarize column
# # directly from the raw merged cloud + SD values.
# 
# # Examples:
# pm25_clean <- make_raw_for_summary(merged_results$pm25, "pm25")
# pm1_clean  <- make_raw_for_summary(merged_results$pm1,  "pm1")
# pm10_clean <- make_raw_for_summary(merged_results$pm10, "pm10")
# 
# # Then call:
# summarized_pm25 <- summarize_pollution_times(pm25_clean, 
#                                              "pm25_data_summarize",
