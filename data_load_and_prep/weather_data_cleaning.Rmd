...
# 
# ## empty SD card when no SD card to merge with 
# full_sd_card <- tibble::tibble(
#   timestamp_iso = lubridate::as_datetime(character()),
#   met_temp = numeric(),
#   met_rh = numeric(),
#   monitor = character(),
#   source  = character()
...
#   select(monitor, date, hour, mean_met_temp)
# 
# rh_hourly <- rh_hourly %>%
#   select(monitor, date, hour, mean_met_rh)
# 
# full_hourly_summary <- left_join(temp_hourly, rh_hourly, by = c("monitor", "date", "hour"))
# 
# write_csv(full_hourly_summary, here("data", "weather", "summarized", "modpm00884_hourly_20250901-20251115.csv"))
# 
# 
# temp_daily <- temp_daily %>%
#   select(monitor, date, mean_met_temp)
# 
# rh_daily <- rh_daily %>%
#   select(monitor, date, mean_met_rh)
# 
# full_daily_summary <- left_join(temp_daily, rh_daily, by = c("monitor", "date"))
# 
# 
# write_csv(full_daily_summary, here("data", "weather", "summarized", "modpm00884_daily_20250901-20251115.csv"))




# save the summarized outputs 
write_rds(temp_hourly, here("data", "weather", "summarized", "temp_hourly_20240816-20250901.rds"))
write_rds(temp_daily, here("data", "weather", "summarized", "temp_daily_20240816-20250901.rds"))
...
write_rds(rh_hourly, here("data", "weather", "summarized", "rh_hourly_20240816-20250901.rds"))
write_rds(rh_daily, here("data", "weather", "summarized", "rh_daily_20240816-20250901.rds"))
