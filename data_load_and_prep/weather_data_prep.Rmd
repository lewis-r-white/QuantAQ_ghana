...
## save outputs
# write_csv(met_temp_merged, here("data", "weather", "merged", "met_temp_merged_20250831-20260315.csv"))
# write_csv(met_rh_merged, here("data", "weather", "merged",  "met_rh_merged_20250831-20260315.csv"))
# write_rds(met_temp_merged, here("data", "weather", "merged", "met_temp_merged_20250831-20260315.rds"))
# write_rds(met_rh_merged, here("data", "weather", "merged", "met_rh_merged_20250831-20260315.rds"))
...
#temp
write_csv(temp_hourly, here("data", "weather", "summarized", "temp_hourly_20250831-20260315.csv"))
write_csv(temp_daily, here("data", "weather", "summarized", "temp_daily_20250831-20260315.csv"))

# rh
write_csv(rh_hourly, here("data", "weather", "summarized", "rh_hourly_20250831-20260315.csv"))
write_csv(rh_daily, here("data", "weather", "summarized", "rh_daily_20250831-20260315.csv"))
...
# save output
write_rds(ws_merged, here("data", "weather", "merged", "ws_merged_20250831-20260315.rds"))
write_rds(wd_merged, here("data", "weather", "merged", "wd_merged_20250831-20260315.rds"))
...
# save output 
# write_rds(temp_rh_full, here("data", "weather", "merged", "temp_rh_full_20250831-20260315.rds"))
...
# save output 
# write_rds(wind_full, here("data", "weather", "merged", "wind_full_20250831-20260315.rds"))
...
# save output 
write_rds(weather_full, here("data", "weather", "all_weather", "all_weather_vars_20250831-20260315.rds"))
```
