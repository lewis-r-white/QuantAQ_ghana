...
# use this if no sd card data
temp_rh_sd_card <- tibble::tibble()  # empty tibble
...
cloud_file <- "/Users/lewiswhite/CHAP_columbia/QuantAQ_ghana/data/all_measurements/cloud/ghana_AQ_parent_full_20240815_20241031.csv"
...
## save outputs
# write_csv(met_temp_merged, here("data", "weather", "merged", "met_temp_merged_20240816-20241031.csv"))
# write_csv(met_rh_merged, here("data", "weather", "merged",  "met_rh_merged_20240816-20241031.csv"))
# write_rds(met_temp_merged, here("data", "weather", "merged", "met_temp_merged_20240816-20241031.rds"))
# write_rds(met_rh_merged, here("data", "weather", "merged", "met_rh_merged_20240816-20241031.rds"))
...
#temp
write_csv(temp_hourly, here("data", "weather", "summarized", "temp_hourly_20240816-20241031.csv"))
write_csv(temp_daily, here("data", "weather", "summarized", "temp_daily_20240816-20241031.csv"))

# rh
write_csv(rh_hourly, here("data", "weather", "summarized", "rh_hourly_20240816-20241031.csv"))
write_csv(rh_daily, here("data", "weather", "summarized", "rh_daily_20240816-20241031.csv"))


## join temp and rh into one summarized df ----
## create temp and rh summarized df
temp_rh_hourly <- left_join(temp_hourly, rh_hourly, by = c("monitor", "date", "hour")) %>%
  select(monitor, date, hour, mean_met_temp, mean_met_rh)

temp_rh_daily <- left_join(temp_daily, rh_daily, by = c("monitor", "date")) %>%
  select(monitor, date, mean_met_temp, mean_met_rh)
...
## USE UF NO SD DATA 
ws_wd_sd_card <- tibble::tibble()  # empty tibble
...
cloud_file <- "/Users/lewiswhite/CHAP_columbia/QuantAQ_ghana/data/all_measurements/cloud/ghana_AQ_parent_full_20250831_20260315.csv"
...
# save output
write_rds(ws_merged, here("data", "weather", "merged", "ws_merged_20240816-20241031.rds"))
write_rds(wd_merged, here("data", "weather", "merged", "wd_merged_20240816-20241031.rds"))
...
# save output 
# write_rds(temp_rh_full, here("data", "weather", "merged", "temp_rh_full_20240816-20241031.rds"))
...
# save output 
# write_rds(wind_full, here("data", "weather", "merged", "wind_full_20240816-20241031.rds"))
...
# save output 
write_rds(weather_full, here("data", "weather", "all_weather", "all_weather_vars_20240816-20241031.rds"))
```
