...
## TESTING LOADING WITH PROGRESS BAR
...
# Install progress package if you haven't
...
ghana_devices <- c("MOD-00400",  "MOD-00398", "MOD-00401", "MOD-00399", "MOD-00397", "MOD-00077")


Sys.setenv(TZ = 'Africa/Accra') # GMT for Ghana

# Define start_date and end_date
start_date <- as.Date("2024-09-01")  # Due to timezones, start_date needs to be 1 day before the actual start date of interest
end_date <- as.Date("2024-10-09")
country = "Ghana"
device_list <- ghana_devices
