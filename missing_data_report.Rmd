...
start_date <- as.Date("2023-12-25") ## DUE TO TIMEZONES, START DATE NEEDS TO BE 1 DAY BEFORE THE ACTUAL START DATE OF INTEREST
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
# Define start_date and end_date
start_date <- as.Date("2023-11-25") ## DUE TO TIMEZONES, START DATE NEEDS TO BE 1 DAY BEFORE THE ACTUAL START DATE OF INTEREST

end_date <- as.Date("2023-12-10")
...
colorful_table %>%
  ...
  formatStyle(
    names(test),  # Apply formatting to all columns
